...
public interface MovieRepository extends JpaRepository<Movie, Long> {
    ...
    List<Movie> retrieveByName(@Param("name") String name);//  Optional <Movie> retrieveByName
    ...
    @Query(value = "SELECT * FROM movie WHERE duration IN ?1 ",nativeQuery = true)// between ?1 and ?2
   List<Movie> retrieveByfDurationInRange(@Param("durations") List<Integer> durations);
